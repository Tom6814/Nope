...
func main() {
	...
	// Persona engine: memory / proactive / agent tools (design §9).
	personaEngine := persona.New(s, objStore, ai.CompleteMessages)
	personaEngine.SetSearcher(persona.NewDuckDuckGoSearcher())
	aiSink.Persona = personaEngine
