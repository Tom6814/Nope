...
func RunAll(t *testing.T, s store.Store) {
	...
	t.Run("Character", func(t *testing.T) { TestCharacterCRUD(t, s) })
	t.Run("Contact", func(t *testing.T) { TestContactCRUD(t, s) })
	t.Run("Memory", func(t *testing.T) { TestMemoryCRUD(t, s) })
	t.Run("ScheduledMessage", func(t *testing.T) { TestScheduledMessageCRUD(t, s) })
	t.Run("PersonaRule", func(t *testing.T) { TestPersonaRuleCRUD(t, s) })
}
